...
import 'package:shamo/pages/lib/presentation/screens/cartScreen/cart.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/categoryScreen/category.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/homeScreen/home.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/loginScreen/login.view.dart';
import 'package:shamo/pages/lib/presentation/screens/onBoardingScreen/onBoarding.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/productDetailScreen/product.detail.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/productScreen/product.screen.dart';
...
import 'package:shamo/pages/lib/presentation/screens/searchScreen/search.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/signUpScreen/signup.screen.dart';
import 'package:shamo/pages/lib/presentation/screens/splashScreen/splash.screen.dart';
  ...
  static Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case profileRoute:
        {
          return MaterialPageRoute(
            builder: (_) => const ProfileScreenn(),
          );
        }
      case categoryRoute:
        {
